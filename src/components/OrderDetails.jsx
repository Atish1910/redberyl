    ...
    <div className="col-lg-4 pe-lg-4 px-4">
      <div className="row border rounded-3 mb-4">
        ...
        <div className="py-3 personal-info">
          <p className="mb-1">
            <i className="bi bi-telephone text-primary pe-2"></i> {order.contact.phone}
          </p>
          <p className="mb-1">
            <i className="bi bi-envelope text-primary pe-2"></i> {order.contact.email}
          </p>
          <p className="mb-1">
            <i className="bi bi-geo-alt text-primary pe-2"></i> {order.contact.address}
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="col-12">
      <ul className="nav nav-tabs">
        <li className="nav-item">
          <button className={`nav-link ${activeTab==="details" ? "active" : "" }`} onClick={()=>
        ...
        <li className="nav-item">
          <button className={`nav-link ${activeTab==="requirements" ? "active" : "" }`} onClick={()=>
        ...
        <li className="nav-item">
          <button className={`nav-link ${activeTab==="contacts" ? "active" : "" }`} onClick={()=>
        ...
        <li className="nav-item">
          <button className={`nav-link ${activeTab==="documents" ? "active" : "" }`} onClick={()=>
        ...
        <li className="nav-item">
          <button className={`nav-link ${activeTab==="manager" ? "active" : "" }`} onClick={()=>
      ...
      <div className="tab-content border border-top-0 p-3 bg-white rounded-bottom">
          ...
          <div className="col-lg-6">
            <div className="card">
              ...
              <div className="card-body border-bottom">
                ...
                <ul>
                  <li>The Filling Fee For the application as per state selected</li>
              ...
              <div className="card-body border-bottom">
                ...
                <ul>
                  <li>Fees To appoint Registered Agent to handle necessary government, tax & legal corrospondence about your business. </li>
                </ul>
              </div>
            </div>
          </div>
                ...
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <i class="bi bi-check2-circle fs-3 text-success"></i>
                    <div className="ps-3">
                      ...
                      <p className="mb-1">Processed By <a href="">customer_name</a></p>
                      <p className="mb-0">Order has been placed successfully</p>
                    </div>
                  </div>
                  
                  <h6 className="card-title mb-0">Mar 28, 2024</h6>
                </div>
              </div>
              <div className="card-body border-bottom">
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <i class="bi bi-check2-circle fs-3 text-success"></i>
                    <div className="ps-3">
                      ...
                      <p className="mb-1">Processed By <a href="">State_manager</a></p>
                      <p className="mb-0">The prepared filling or has been submitted to the approprieate state or government agency</p>
                    </div>
                  </div>
        ...
        <p><strong>Requirements will be displayed here...</strong></p>
        )}
        {activeTab === "contacts" && (
        <p><strong>Contacts tab content here...</strong></p>
        )}
        {activeTab === "documents" && (
        <p><strong>Documents tab content here...</strong></p>
        )}
        {activeTab === "status" && (
        <p><strong>Status History tab content here...</strong></p>
        )}
        {activeTab === "manager" && (
        <p><strong>Account Manager tab content here...</strong></p>
        )}
      </div>
    </div>
  </div>
